var S=Object.defineProperty;var w=e=>{throw TypeError(e)};var R=(e,t,n)=>t in e?S(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var v=(e,t,n)=>R(e,typeof t!="symbol"?t+"":t,n),x=(e,t,n)=>t.has(e)||w("Cannot "+n);var a=(e,t,n)=>(x(e,t,"read from private field"),n?n.call(e):t.get(e)),f=(e,t,n)=>t.has(e)?w("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),d=(e,t,n,r)=>(x(e,t,"write to private field"),r?r.call(e,n):t.set(e,n),n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const u of s.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();function C(e){const t=y(e);return t?t.innerHTML="":document.body.innerHTML=`<div id='${e}'></div>`,t}function y(e){try{return typeof e=="string"?document.querySelector(e):e}catch(t){throw new Error("올바른 셀렉터를 입력해주세요.",t)}}const h=[];function k(e){return{render(t){h.length=0;const n=e(),r=y(t);r.innerHTML=n,h.length>0&&h.forEach(o=>o())}}}function g(e){h.push(e)}class E{constructor(t,n,r){this.root=t,this.routes=n,this.guard=null,this.basePath=r.basePath??"/",this.content=document.createElement("div"),this.root.appendChild(this.content)}getCurrentPath(){const n=window.location.pathname.replace(this.basePath,"/");return this.formatPath(n)}getRoute(t){const n=this.routes[t]??this.routes["*"];return n.redirect?this.getRoute(n.redirect):n}renderComponent(t,n){const r=this.basePath+n.replace(/^\/+/,""),{component:o}=t;if(typeof o!="function")throw new Error(`"${n}" 컴포넌트가 없습니다.`);window.history.pushState(null,"",r),k(o).render(this.root)}formatPath(t){throw new Error("formatPath 메서드는 상속 클래스에서 구현해야 합니다.")}renderRoute(t){const n=(r=t)=>{const o=this.formatPath(r),s=this.getRoute(o);this.renderComponent(s,o)};this.guard?this.guard(this.formatPath(t),n):n()}start(){throw new Error("start 메서드는 상속 클래스에서 구현해야 합니다.")}navigate(t){throw new Error("navigate 메서드는 상속 클래스에서 구현해야 합니다.")}beforeEach(t){return this.guard=t,this}}class O extends E{formatPath(t){return t.replace("#","")||"/"}getCurrentPath(){const t=window.location.hash;return this.formatPath(t)}start(){this.renderRoute(window.location.hash),window.addEventListener("hashchange",()=>{const t=window.location.hash;t&&this.renderRoute(t)})}navigate(t){window.location.hash=t}}class T extends E{formatPath(t){return t.replace(this.basePath,"/")}start(){this.renderRoute(window.location.pathname),window.addEventListener("popstate",()=>{this.renderRoute(window.location.pathname)}),window.addEventListener("DOMContentLoaded",()=>{document.body.addEventListener("click",this.onLinkClick.bind(this))})}onLinkClick(t){const n=t.target.closest("a");if(!n)return;t.preventDefault();const r=n.href.replace(window.location.origin,"");window.location.pathname!==r&&this.renderRoute(r)}navigate(t){this.renderRoute(t)}}function j(e,t,{mode:n}){const r="/front_5th_chapter1-1/";switch(n){case"history":return new T(e,t,{basePath:r});case"hash":return new O(e,t,{basePath:r});default:throw new Error("올바른 라우터 타입이 아닙니다.")}}var i,c;const l=class l{constructor(){f(this,i,null);f(this,c,"user");if(l.instance)return l.instance;l.instance=this,d(this,i,JSON.parse(localStorage.getItem(a(this,c))||"null"))}setUserInfo(t){d(this,i,t),localStorage.setItem(a(this,c),JSON.stringify(t))}removeUserInfo(){d(this,i,null),localStorage.removeItem(a(this,c))}get userInfo(){return a(this,i)}get isAuthenticated(){return a(this,i)!==null}};i=new WeakMap,c=new WeakMap,v(l,"instance");let p=l;function m(){return new p}const b=new Map;function M(e,t){b.set(e,t)}function P(e){if(!b.has(e))throw new Error(`"${e}"에 대한 provider가 없습니다.`);return b.get(e)}function L(){const e=m(),t=P("router");function n(o){return t.getCurrentPath()===o}function r(o){return o?"text-blue-600 font-bold":"text-gray-600"}return g(()=>{const o=document.getElementById("logout");o==null||o.addEventListener("click",s=>{s.preventDefault(),e.removeUserInfo()})}),`
      ...
      <nav class="bg-white shadow-md p-2 sticky top-14">
        <ul class="flex justify-around" id="menu">
          <li><a href="/" data-link class="${r(n("/")||n("/main"))}">홈</a></li>
          <li><a href="/profile" data-link class="${r(n("/profile"))}">프로필</a></li>
          ${e.isAuthenticated?'<li><a href="/login" id="logout" data-link class="text-gray-600">로그아웃</a></li>':`<li><a href="/login" data-link class="${r(n("/login"))}">로그인</a></li>`}
        </ul>
      </nav>
    `}function $(){return`
  ...
  `}const F={"/":{redirect:"/main"},"/login":{component:B},"/main":{component:H},"/profile":{component:D},"*":{component:N}},U=(e,t)=>{const n=m();!n.isAuthenticated&&e==="/profile"?t("/login"):n.isAuthenticated&&e==="/login"?t("/"):t()},J=C("#root"),I=j(J,F,{mode:"history"});M("router",I);I.beforeEach(U).start();
